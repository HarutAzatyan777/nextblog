...
const PostCard = ({ post }) => {
  return (
    <article className="post-card bg-white shadow-lg rounded-lg p-0 lg:p-8 pb-10 mb-8">
      {/* Featured Image */}
      <div className="relative shadow-md mb-6">
        <Image
          ...
          layout="responsive" // Changed to responsive for better sizing
          width={500} // Set standard width
          height={300} // Set standard height
      ...
      {/* Title */}
      <h1 className="post-card__title transition duration-700 text-center mb-8 cursor-pointer hover:text-pink-600 text-xl font-semibold">
